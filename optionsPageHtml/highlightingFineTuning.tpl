<label for="HighlightTags" class="fine-tuning-label">
...
<label for="HideHashtags" class="sub-setting fine-tuning-label">
...
<label for="HighlightTitles" class="fine-tuning-label">
...
<label for="MatchTitleSubstrings" class="sub-setting fine-tuning-label">
